...
import "server-only" // importing and making this a server-only function/component. Now, the application until you remove/comment out this function in "/client-route"
