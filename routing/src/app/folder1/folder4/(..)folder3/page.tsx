const InterceptedFolder4 = () => {
  return (
    // NOTE: This is a folder that uses intercepted routes. If you click "Goto Folder3" in "/floder4" page, it comes here instead of the page.tsx defined in folder3/page.tsx.
...
export default InterceptedFolder4